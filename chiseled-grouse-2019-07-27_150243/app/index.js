...
client.on('guildMemberAdd', member => {
  ...
  .addField("🌐 Sunucuya hoşgeldin! 📌 ", "Sunucuya hizmet vermek için bu sunucuda bulunmaktayım!\nBeni sunucuna ekleyebilmek için: https://discordapp.com/oauth2/authorize?client_id=600057001879535616&scope=bot&permissions=2080374975")
  .addField("<a:heart:537567915852169217> İyi Günler :) ")
  .setDescription('\nİyilik ve Eğlence  🎆')
    .setFooter('İyilik ve Eğlence  🎆 ', client.user.avatarURL , 'https://cdn.discordapp.com/attachments/547445417667854346/548570747111604255/kalp1.png' )
  member.send(merhaba);
});
...
const yourID = "500701212086108172"; //Instructions on how to get this: https://redd.it/40zgse //Kendi İD'nizi Yazın
const setupCMD = "!kayıtol" //İstediğiniz Komut Yapabilirsiniz örn : !kayıtol
let initialMessage = `Emojiye Tıklayarak   Rol Alabilirsiniz`; //Dilediğiniz Şeyi Yazabilirsiniz
const roles = ["Male", "Female"]; //İstediğiniz Rolü Yazabilirsiniz
const reactions = ["🍉", "🍇"]; //İstediğiniz Emojiyi Ekleyebilirsiniz
const botToken = "NjAwMDU3MDAxODc5NTM1NjE2.XTqZcg.8PnnH4robvINzsq7v6iOHDiQS6g";  //Buraya botunuzun tokenini koyunuz
...
function panel1() {
    return new Promise(resolve => {
        setTimeout(() => {
            client.channels.get(`604040647569309707`).setName(`🇹🇷 Türkiyenin `); //Gerekli Yerleri Doldurun
            panel2();
  ...
  function panel2() {
    return new Promise(resolve => {
        setTimeout(() => {
            client.channels.get(`604040647569309707`).setName(`🇹🇷 En `); //Gerekli Yerleri Doldurun
            panel3();
  ...
  function panel3() {
    return new Promise(resolve => {
        setTimeout(() => {
            client.channels.get(`604040647569309707`).setName(`🇹🇷 Güvenilir Botu`); //Gerekli Yerleri Doldurun
            panel4();
        }, 1600); //Hızı, Sayıyı Fazla Düşürmeyin
      });
  }
  function panel4() {
    return new Promise(resolve => {
        setTimeout(() => {
            client.channels.get(`604040647569309707`).setName(`🇹🇷 TreX Bot`); //Gerekli Yerleri Doldurun
            panel1();
        }, 1600); //Hızı, Sayıyı Fazla Düşürmeyin
      });
  }
